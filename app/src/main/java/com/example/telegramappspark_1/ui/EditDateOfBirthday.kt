...
@Composable
fun aboutUserEdit(user: UserData) {
    Box()
        ...
        LazyColumn(
            ...
            item {
                ...
                Column(
                    ...
                    Text(
                        "Вы можете выбрать, кому доступен просмотр", color = Color.Gray,
                        fontSize = 16.sp,
                    )
                    ...
                    Row(
                        ...
                        Text(
                            "раздела \"О себе\"  в вашем профиле.", color = Color.Gray,
                            fontSize = 16.sp,
                        )
                    }
                }
...
@Preview
@Composable
fun Selegr2amAppSpdark1Thgemsde() {
    aboutUserEdit(
        user = UserData(
            UsFirstName = "Alex",
